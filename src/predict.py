...
def set_args():
    ...
    parser.add_argument('--model_dir', default='models', type=str, help='模型文件路径')
...
def main():
    ...
    model.eval()
    content_list = [
        '5月8日茶魂普洱创造半天售罄600份的奇迹，是苦涩难忘，还是回甘入心？茶是神奇的树叶，茶魂又是怎样摄人心魄？不要问我茶的滋味，我的故乡在景迈山。但愿苏爷爷的茶魂茶里有你喜欢的味道，今年最后600份等着你。景迈山茶魂普洱 零利润回馈粉丝 ',
        '财政部、国家税务总局今天发布《关于房屋、土地权属由夫妻一方所有变更为夫妻双方共有契税政策的通知》，通知显示，婚姻关系存续期间，房屋、土地权属原归夫妻一方所有，变更为夫妻双方共有的，免征契税，通知自印发之日起执行。'
    ]
