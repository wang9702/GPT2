...
def split_data():
    lines = json.load(open('../data/train_data.json', encoding='utf8'))
    print(len(lines))
    # random.shuffle(lines)
    # json.dump(lines[:2700], open('../data/train.json', 'w', encoding='utf8'), ensure_ascii=False, indent=2)
    # json.dump(lines[:300], open('../data/test.json', 'w', encoding='utf8'), ensure_ascii=False, indent=2)
